...
public class Book
{
	...
	public Book ()
	{
		...
		title = "EMPTY";
		author = "EMPTY";
		dateOfPublication = stringToDate("00.00.0000");
		price = 0;

	}

	public Book (int id_input,String title_input, String author_input, Date date_input, int price_input)
	{
		id = id_input;
		title = title_input;
		author = author_input;
		dateOfPublication = date_input;
	...
	public int setPrice(int scn_price)
	{
		if (scn_price < 0)
			price = 0;
		else
